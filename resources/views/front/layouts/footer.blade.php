<div class="container">
 <div class="row">
  ...
  <div class="col-md-4">
   <h2>تماس با ما</h2>
   <address>
    <p><strong><i class="fa fa-envelope"
                  aria-hidden="true"></i> ایمیل: </strong> info [at] kiusk.ca </p>
   </address>
...
<div class="background">
 <div class="background-image original-size"
      style="background-image: url({{asset('images/footer-background-icons.jpg')}});">
  <img src="{{asset('images/footer-background-icons.jpg')}}"
       alt="کیوسک | نیازمندی های ایرانیان کانادا | آگهی رایگان نیازمندی ها">
 </div>
